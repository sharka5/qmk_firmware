...
*/ 				
    ...
    [_FL] =   { {     RESET,  KC_SLCK,  KC_PAUS,   KC_APP,  _______,  RGB_VAI,    RGB_VAD,  KC_MPRV,  KC_MPLY,  KC_MNXT,   KC_MUTE,     KC_VOLD,   KC_VOLU,  _______,  KC_PSCR,  _______,  _______,  KC_SLEP,  RGB_TOG },
                ...
                {   MOD_LCTL,  KC_LGUI,  KC_LALT,    KC_NO,    KC_NO,    KC_NO,  TG(_SIMS),  _______,    KC_NO,    KC_NO,   _______,     MO(_FL),   _______,  _______,  _______,  _______,  _______,  _______,    KC_NO }
              },  
...
*/ 				
    ...
    [_CTRL] = { {   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,   _______,     _______,   _______,  _______,  _______,  _______,  _______,  _______,  _______ },
                ...
                {   MOD_LCTL, _______,  _______,    KC_NO,    KC_NO,    KC_NO,  _______,    KC_NO,    KC_NO,    KC_NO,   _______,     TG(_FL),   _______,  _______,  _______,  _______,  _______,  _______,    KC_NO }
              },
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    case _CTRL:
        ...
        rgb_matrix_set_color (93, RGB_PURPLE);   // fn
        break;
